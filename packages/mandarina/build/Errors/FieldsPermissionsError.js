...
exports.FieldsPermissionsError = void 0;
...
var FieldsPermissionsError = /** @class */ (function (_super) {
    ...
    function FieldsPermissionsError(action, invalidFields) {
        return _super.call(this, "You cannot execute the \"".concat(action, "\" action over these fields: ").concat(invalidFields.join(', '))) || this;
    }
