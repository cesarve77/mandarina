        ...
        _this.onScroll = function (_a) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.onScrollTimeoutId = window.setTimeout(function () {
                    ...
                    if (_this.data.length && __spreadArrays(_this.data).slice(_this.visibleRowStartIndex, _this.visibleRowStopIndex + (_this.props.overscanRowCount || 2)).every(function (val) { return val !== undefined; })) {
                        resolve(false);
                        return;
                    }
