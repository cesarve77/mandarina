...
var ConfirmActionButton = /** @class */ (function (_super) {
    __extends(ConfirmActionButton, _super);
    ...
    ConfirmActionButton.prototype.render = function () {
        var _this = this;
        var _a = this.props, result = _a.result, data = _a.data, schema = _a.schema, actionName = _a.actionName, onSuccess = _a.onSuccess, _b = _a.refetchQueries, refetchQueries = _b === void 0 ? this.refetchQueries : _b, onCompleted = _a.onCompleted, update = _a.update, ignoreResults = _a.ignoreResults, optimisticResponse = _a.optimisticResponse, awaitRefetchQueries = _a.awaitRefetchQueries, onError = _a.onError, context = _a.context, resultFields = _a.resultFields, innerRef = _a.innerRef, modalProps = _a.modalProps, rest = __rest(_a, ["result", "data", "schema", "actionName", "onSuccess", "refetchQueries", "onCompleted", "update", "ignoreResults", "optimisticResponse", "awaitRefetchQueries", "onError", "context", "resultFields", "innerRef", "modalProps"]);
        var queryFromFields = '';
        ...
        return (React.createElement(react_apollo_1.Mutation, { mutation: MUTATION, onCompleted: onCompleted, 
            ...
            return (React.createElement(button_1.default, __assign({ loading: loading }, rest, { ref: innerRef, onClick: function (e) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        onOk = modalProps.onOk, props = __rest(modalProps, ["onOk"]);
                        antd_1.Modal.confirm(__assign(__assign({}, props), { onOk: function (arg) {
                                onOk && onOk(arg);
                                return mutation({ variables: { data: data } }).then(function (result) { return onSuccess && onSuccess(result); });
                            } }));
                        return [2 /*return*/];
                    });
                }); } })));
...
//# sourceMappingURL=ConfirmActionButton.js.map