    ...
    CustomAuto.prototype.render = function () {
        ...
        if (props.component === undefined) {
            if (props.allowedValues) { //todo
                ...
                invariant_1.default(props.component, 'Unsupported field type in: %s', props.name);
            }
        }
        ...
        if (mergeProps.col === false)
            return react_1.createElement(props.component, mergeProps);
        var col = typeof mergeProps.col !== 'object' ? { span: mergeProps.col || 24 } : mergeProps.col ? __assign({}, mergeProps.col) : { span: 24 };
        return (react_1.default.createElement(antd_1.Col, __assign({}, col, { "data-id": mergeProps.name }), react_1.createElement(props.component, mergeProps)));
    };
